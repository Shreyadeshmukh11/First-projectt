      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0" style="font-family: times new roman; color: darkmagenta;">Case  Form</h3></div>
              <div class="col-sm-6">
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title" style= " color: deeppink;">Case Form</h3>
                      <button
                        type="button"
                        class="btn btn-tool"
...
<form action="submit_case.php" method="POST">
    ...
    <div class="mb-3">
        <label for="lawyer_id" class="form-label">Lawyer ID</label>
        <input type="text" class="form-control" id="lawyer_id" name="lawyer_id" required>
    </div>
