      ...
      <main class="app-main">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="create_case.php" class="btn btn-primary" name="save" value="create">
                Case Form
                </a>
              </div>
            </div>
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-8"><h3 class="mb-0"> Case Enquiry </h3></div>
              <div class="col-sm-4">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Case Form</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
...
<head>
  ...
  <!-- Optional: AdminLTE CSS -->
  <link rel="stylesheet" href="../css/adminlte.css">
</head>
<body class="bg-light">

<div class="container mt-5">
  <h2 class="mb-4 text-primary" style="font-family: Times New Roman;">Case List</h2>
  <table id="caseTable" class="table table-bordered table-striped">
    ...
    <tbody>
      <?php
      $sql = "SELECT * FROM cases ORDER BY start_date DESC";
      ...
      <tr>
        ...
        <td><?= htmlspecialchars($row['lawyer_id']) ?></td>
